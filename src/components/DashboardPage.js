    ...
    return(
        <>
            ...
            <div className="top-bar">
                <ul>
                <li><div className="toggle"><h2>Dashboard</h2></div></li>
                <li><div className="search"><input type="text" placeholder="Search"/><button>GO</button></div></li>
                <li><div className="user"><img src="../Images/avatar.png" alt="" className="user-img"/></div></li>
                </ul>
            </div>
